...
"""
pyqt_sw09_LCD_Slider_Button_Vererbung.py

Erweiterung des Slider-LCD-Beispiels
um zwei QPushButtons '<' und '>'
Diese bekommen durch Verebung weitere 
Eigenschaften und einen eigenen slot()
